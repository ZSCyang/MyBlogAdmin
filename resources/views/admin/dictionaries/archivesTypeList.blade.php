    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox-title">
                <h5>博文管理 > <span class="current_nav">博文类型列表</span></h5>
            ...
            <div class="ibox-content">
                ...
                <form method="post" action="" name="form">
                    ...
                    <table class="table table-striped table-bordered table-hover m-t-md">
                        ...
                        <tbody>
                        @if(count($archivesTypeList) > 0)
                            @foreach($archivesTypeList as $archiveType)
                                <tr id="data_{{$archiveType->id}}">
                                    <td class="text-center">{{$archiveType->name}}</td>
                                    <td class="text-center">
                                        <img src="{{$archiveType->logo}}" class="samll-img-rounded" alt="" data-action="zoom" class="pull-left">
                                    </td>
                                    <td class="text-center">{{$archiveType->status}}</td>
                                    <td class="text-center">{{$archiveType->created_at}}</td>
                                    <td class="text-center">{{$archiveType->updated_at}}</td>
                                    <td class="text-center">
                                        <div class="btn-group">
                ...
                {{ $archivesTypeList->appends([])->links() }}
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="dialog-title">添加博文类型</h4>
                </div>
